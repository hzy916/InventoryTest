        ...
        ?>
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="/DeliveryRequests/delivery_table.php">
         ...
         <?php } ?>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="/DesignRequests/custom_request_table.php">
                  <span class="float-left">View Details</span>
                </a>
              </div>
            </div> 
